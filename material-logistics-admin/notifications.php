...
<body>
	<div class="wrapper">
		<?php 
			include("../sidebar/material-logistics-sidebar.php"); 
			$query_notification_status = "UPDATE transit_data SET notification_status = FALSE WHERE user_id = $material_logistics_id"; 
									...
									<div class="card flex-fill mt-2">
										...
										<?php foreach($recent as $r){ ?>
												<div class="card-body">
													...
													<i class="align-middle text-success" data-feather="check-circle"></i> <span class="align-middle"> <?php echo ucfirst($r->po_status); ?> : Purchasing Division validate your transaction with PO No. "<?php echo $r->po_no; ?>"</span>
													<?php } else {?>
														<i class="align-middle text-danger" data-feather="x-circle"></i> <span class="align-middle"> Reject : Purchasing Division reject your transaction with PO No. "<?php echo $r->po_no; ?>"</span>	
													<?php }?>
												</div>
										<?php 
												}		
